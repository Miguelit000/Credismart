...
function Solicitar() {
  ...
  const handleSubmit = (e) => {
    ...
    setMensaje(`¡Solicitud enviada con éxito, ${formData.nombre}! Tu asesor te contactará pronto.`);
      ...
      <form onSubmit={handleSubmit} className="card card-body shadow-sm">
        ...
        <div className="row g-3 mb-4">
          <div className="col-md-6">
            ...
            <input 
              type="text" className="form-control" name="nombre" required 
          ...
          <div className="col-md-6">
            ...
            <input 
              type="number" className="form-control" name="cedula" required
        ...
        <div className="row g-3 mb-4">
          ...
          <div className="col-md-6">
            ...
            <select 
              className="form-select" name="tipoCredito" required
          ...
          <div className="col-md-6">
            ...
            <select 
              className="form-select" name="plazo" 
              value={formData.plazo} onChange={handleChange}
            >
          ...
          <div className="col-md-12">
            ...
            <input 
              type="number" className="form-control" name="monto" required min="1000000"
